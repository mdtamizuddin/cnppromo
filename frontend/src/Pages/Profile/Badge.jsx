...
const Badge = ({ number, width, height }) => {
  if (number === 1) {
    return (
      <svg
        ...
        viewBox={`0 0 ${width ? width : 75} ${height ? height : 100}`}
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
          class="badge_ribbon left"
    ...
    return (
      <svg
        ...
        height={height ? height : 100}
        viewBox={`0 0 ${width ? width : 84} ${height ? height : 100}`}
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
    ...
    return (
      <svg
        ...
        width={width ? width : 75}
        height="98"
        viewBox={`0 0 ${width ? width : 75} ${height ? height : 98}`}
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
    ...
    return (
      <svg
        ...
        viewBox={`0 0 ${width ? width : 84} ${height ? height : 99}`}
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
