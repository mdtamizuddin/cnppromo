...
const gatewayPresets = [
  ...
  },
  {
    ...
    subName: "Direct Mobile Recharge",
    type: "Mobile Banking",
    currency: "BDT",
    fee: "0.00%",
    feeType: "percentage",
    accountType: "Personal",
    accountName: "CNP Mobile Recharge",
    minAmount: 30,
    maxAmount: 5000,
    dailyLimit: 20000,
    processingTime: "5-30 Minutes",
    instructions: "যে মোবাইল নম্বরে রিচার্জ করতে চান সেটি এবং পরিমাণ দিন। রিকোয়েস্ট গৃহীত হলে সরাসরি ঐ নম্বরে রিচার্জ করে দেওয়া হবে।",
    notice: "সর্বনিম্ন রিচার্জ পরিমাণ ৳৩০।",
    icon: "/logo/recharge.png",
    tags: ["Recharge", "Low Minimum"],
  },
  {
    name: "Upay",
