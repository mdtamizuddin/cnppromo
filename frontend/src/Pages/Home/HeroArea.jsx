...
const HeroIllustration = () => (
    <div className="relative w-full max-w-[500px] aspect-square mx-auto flex items-center justify-center">
        ...
        <div className="absolute inset-0 bg-[#0D9488]/10 rounded-full blur-3xl scale-90"></div>
        <div className="absolute bottom-10 -left-4 w-32 h-32 bg-cyan-400/20 rounded-full blur-2xl"></div>
        <div className="absolute top-10 -right-4 w-32 h-32 bg-teal-400/20 rounded-full blur-2xl"></div>
        
        {/* Base Platform */}
        <div className="absolute bottom-12 w-[80%] h-[40px] bg-teal-950/10 rounded-[100%] shadow-[0_20px_40px_rgba(13,148,136,0.2)]"></div>
        <div className="absolute bottom-14 w-[75%] h-[35px] bg-[#0D9488] rounded-[100%] border-4 border-[#14b8a6] z-10"></div>
        ...
        <div className="absolute z-20 w-[180px] h-[360px] bg-[#0b0c2a] rounded-[30px] border-8 border-gray-800 shadow-2xl rotate-[5deg] right-12 bottom-20 flex flex-col items-center pt-3 pb-6 px-2 overflow-hidden">
            ...
            {/* Screen */}
            <div className="w-full h-full bg-gradient-to-b from-[#0D9488] to-[#2dd4bf] rounded-[18px] relative overflow-hidden">
        ...
        {/* Wallet Mockup */}
        <div className="absolute z-30 w-[220px] h-[160px] bg-[#0D9488] rounded-2xl shadow-2xl shadow-teal-500/40 left-8 bottom-24 overflow-hidden border-b-[8px] border-[#0f766e]">
            <div className="absolute top-0 w-full h-[60px] bg-[#14b8a6] rounded-t-2xl shadow-inner flex items-center justify-center border-b-2 border-[#2dd4bf]">
                <div className="w-16 h-4 bg-[#2dd4bf] rounded-full"></div>
            </div>
            ...
            {/* Wallet Flap Overlay */}
            <div className="absolute inset-0 bg-gradient-to-b from-[#0D9488] to-[#0f766e] mt-[45px] z-20 flex items-center justify-center shadow-[0_-10px_20px_rgba(0,0,0,0.1)]">
                {/* Button/Lock */}
                <div className="w-12 h-12 bg-[#042f2e] rounded-full shadow-inner flex items-center justify-center mb-8 border-2 border-[#0f766e]">
        ...
        {/* Floating Badges */}
        <div className="absolute z-40 w-16 h-16 bg-[#0D9488] rounded-full left-4 top-20 shadow-lg shadow-teal-500/40 border-4 border-[#f8f9ff] flex items-center justify-center text-white text-2xl animate-bounce" style={{animationDuration: '3s'}}>
            ৳
        </div>
                ...
                >
                    <div className="space-y-4">
                        <h1 className="text-3xl lg:text-[42px] font-bold leading-[1.2] tracking-tight text-[#0b0c2a]">
                            <span className="text-primary block mb-2">CNP-PROMO</span>
                            থেকে টাকা আয় করুন !!!
                        </h1>
                    ...
                    <div className="flex flex-wrap items-center gap-5 mt-2">
                        <Link to="/register">
                            <button className="bg-primary hover:bg-primary-hover text-white px-8 py-3.5 rounded-full font-bold text-[16px] transition-all shadow-lg shadow-teal-500/30 flex items-center gap-3">
                                Join Now <FontAwesomeIcon icon={faArrowRight} />
                            </button>
                        </Link>
                        <Link to="/how-it-works">
                            <button className="bg-white border-2 border-gray-200 hover:border-primary text-gray-700 hover:text-primary px-8 py-3.5 rounded-full font-bold text-[16px] transition-all flex items-center gap-3">
